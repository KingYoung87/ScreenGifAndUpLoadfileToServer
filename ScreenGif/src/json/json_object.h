 ...
 */
X_API struct json_object* STDCALL
json_object_get(struct json_object *obj);
 ...
 */
X_API int STDCALL
json_object_is_type(struct json_object *obj, enum json_type type);
 ...
 */
X_API struct array_list* STDCALL
 ...
 */
X_API int STDCALL
json_object_array_length(struct json_object *obj);
 ...
 */
X_API int STDCALL
json_object_array_add(struct json_object *obj,
				 struct json_object *val);
 ...
 */
X_API int STDCALL
json_object_array_put_idx(struct json_object *obj, int idx,
				     struct json_object *val);
 ...
 */
X_API struct json_object* STDCALL
json_object_array_get_idx(struct json_object *obj,
						     int idx);
 ...
 */
X_API struct json_object* STDCALL
json_object_new_boolean(/*boolean*/bl b);
...
X_API const char* STDCALL
json_object_get_field_string(struct json_object *jso, const char *key);

X_API int STDCALL
json_object_get_field_int(struct json_object *jso, const char *key, int def);

X_API double STDCALL
json_object_get_field_double(struct json_object *jso, const char *key, double def);

X_API int STDCALL
json_object_array_del(struct json_object *obj, int idx);
